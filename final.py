...
print('Доп. название заметки: ', title1)
title2 = input('Введите доп. название заметки: ')
print('Доп. название заметки: ', title2)
...
note = [allname, alltitle, content, status, created_date, issue_date]
print('ФИО: ', allname, 'Заметка : ', alltitle, 'Описание: ', content, 'Статус: ', status, 'Начало: ', created_date, 'Конец: ', issue_date)